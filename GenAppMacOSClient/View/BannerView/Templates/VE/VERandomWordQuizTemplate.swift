...
struct VERandomWordQuizTemplate {
    static func template1(textColorPrimary: Color, backColorPrimary: Color, surfaceColor: Color) -> TemplateData {
        ...
        let text1691584128916 = TextShapeModel(shape: .text, color: textColorPrimary, x: 729, y: 35, width: 100, height: 100, text: "k", size: 18, font: .regular)
        let text1691584199109 = TextShapeModel(shape: .text, color: textColorPrimary, x: 776, y: 35, width: 100, height: 100, text: "a", size: 18, font: .regular)
        let text1691584216720 = TextShapeModel(shape: .text, color: textColorPrimary, x: 870, y: 35, width: 100, height: 100, text: "a", size: 18, font: .regular)
