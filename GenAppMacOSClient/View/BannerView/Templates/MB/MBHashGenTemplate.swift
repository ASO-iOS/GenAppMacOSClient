...
struct MBHashGenTemplate {
    ...
    func template1(buttonColorPrimary: Color, textColorPrimary: Color) -> TemplateData {
        ...
        var image1690473649858 = ImageShapeModel(color: .white, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/keyboard.png", x: 69, y: 295, width: 0, height: 0)
        var image1690535834913 = ImageShapeModel(color: .white, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/keyboard.png", x: 387, y: 295, width: 0, height: 0)
        var image1690535856694 = ImageShapeModel(color: .white, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/keyboard.png", x: 705, y: 295, width: 0, height: 0)
