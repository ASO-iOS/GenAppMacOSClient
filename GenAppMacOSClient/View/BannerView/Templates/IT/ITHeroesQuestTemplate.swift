...
struct ITHeroesQuestTemplate {
    static func template1(backColorPrimary: Color, textColorPrimary: Color, surfaceColor: Color, buttonColorPrimary: Color, buttonTextColorPrimary: Color) -> TemplateData {
        ...
        let text1691414408120 = TextShapeModel(shape: .text, color: textColorPrimary, x: 425, y: 72, width: 200, height: 100, text: "First Robin name?", size: 23, font: .regular)
        let text1691414501662 = TextShapeModel(shape: .text, color: textColorPrimary, x: 743, y: 72, width: 200, height: 100, text: "First Robin name?", size: 23, font: .regular)
        ...
        let text1691415452453 = TextShapeModel(shape: .text, color: textColorPrimary, x: 425, y: 171, width: 100, height: 100, text: "Tim Drake", size: 14, font: .regular)
        let text1691415516311 = TextShapeModel(shape: .text, color: textColorPrimary, x: 425, y: 220, width: 100, height: 100, text: "Jason Tod", size: 14, font: .regular)
        let text1691415584908 = TextShapeModel(shape: .text, color: textColorPrimary, x: 425, y: 271, width: 100, height: 100, text: "Bruce Wayne", size: 14, font: .regular)
        let text1691415646897 = TextShapeModel(shape: .text, color: textColorPrimary, x: 425, y: 321, width: 100, height: 100, text: "Dick Grayson", size: 14, font: .regular)
        let text1691415671168 = TextShapeModel(shape: .text, color: textColorPrimary, x: 744, y: 171, width: 100, height: 100, text: "Tim Drake", size: 14, font: .regular)
        let text1691415697845 = TextShapeModel(shape: .text, color: textColorPrimary, x: 744, y: 220, width: 100, height: 100, text: "Jason Tod", size: 14, font: .regular)
        let text1691415712481 = TextShapeModel(shape: .text, color: textColorPrimary, x: 744, y: 271, width: 100, height: 100, text: "Bruce Wayne", size: 14, font: .regular)
        let text1691415726071 = TextShapeModel(shape: .text, color: textColorPrimary, x: 744, y: 321, width: 100, height: 100, text: "Dick Grayson", size: 14, font: .regular)
        let text1691416678397 = TextShapeModel(shape: .text, color: textColorPrimary, x: 760, y: 195, width: 100, height: 100, text: "Your score: 2", size: 16, font: .regular)
        let text1691416792453 = TextShapeModel(shape: .text, color: buttonColorPrimary, x: 769, y: 242, width: 100, height: 100, text: "Return to menu", size: 9, font: .regular)
        let text1691416876020 = TextShapeModel(shape: .text, color: buttonColorPrimary, x: 850, y: 242, width: 100, height: 100, text: "Test again", size: 9, font: .regular)
