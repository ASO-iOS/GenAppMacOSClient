...
struct KLWordFinderTmplate {
    ...
    static func template1(backColorPrimary: Color, textColorPrimary: Color, textColorSecondary: Color, buttonColorPrimary: Color, buttonTextColorPrimary: Color, buttonColorSecondary: Color, surfaceColor: Color, onSurfaceColor: Color, appName: String) -> TemplateData {
        ...
        let text1692192925617 = TextShapeModel(shape: .text, color: textColorPrimary, x: 140, y: 130, width: 116, height: 100, text: appName, size: 22, font: .light)
        ...
        let image1692193303386 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/full.png", x: 402, y: 140, width: 220, height: 220)
//        let image1692193506631 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/letters_1.png", x: 402, y: 140, width: 220, height: 220)
        ...
        let image1692197281785 = ImageShapeModel(color: textColorPrimary, template: true, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/hint.png", x: 604, y: 94, width: 10, height: 13)
        let image1692197372509 = ImageShapeModel(color: textColorPrimary, template: true, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/hint.png", x: 923, y: 94, width: 10, height: 13)
        let image1692197406703 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/full_2.png", x: 720, y: 140, width: 220, height: 220)
//        let image1692198599735 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/letters_2.png", x: 720, y: 140, width: 220, height: 220)
        let image1692198840261 = ImageShapeModel(color: textColorPrimary, template: true, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/clear.png", x: 599, y: 425, width: 10, height: 10)
        let image1692198894451 = ImageShapeModel(color: textColorPrimary, template: true, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/klwordfinder/clear.png", x: 918, y: 425, width: 10, height: 10)
        
        return TemplateData(shapes: [
            "object1692192925617" : text1692192925617,
            "object1692192995991" : rect1692192995991,
            "object1692193057828" : rect1692193057828,
            "object1692193064041" : rect1692193064041,
            "object1692193075462" : rect1692193075462,
            "object1692193096996" : text1692193096996,
            "object1692193142761" : text1692193142761,
            "object1692193163974" : text1692193163974,
            "object1692193174070" : text1692193174070,
            "object1692193303386" : image1692193303386,
//            "object1692193506631" : image1692193506631,
            "object1692193576625" : rect1692193576625,
            "object1692193647624" : text1692193647624,
            "object1692193694742" : text1692193694742,
            "object1692193746968" : text1692193746968,
            "object1692193810706" : text1692193810706,
            "object1692193822580" : text1692193822580,
            "object1692193835556" : text1692193835556,
            "object1692193872427" : rect1692193872427,
            "object1692197281785" : image1692197281785,
            "object1692197372509" : image1692197372509,
            "object1692197406703" : image1692197406703,
//            "object1692198599735" : image1692198599735,
            "object1692198656088" : rect1692198656088,
            "object1692198684995" : rect1692198684995,
            "object1692198739664" : rect1692198739664,
            "object1692198763171" : rect1692198763171,
            "object1692198840261" : image1692198840261,
            "object1692198894451" : image1692198894451,
            "object1692198942252" : text1692198942252,
            "object1692198968399" : text1692198968399
        ])
