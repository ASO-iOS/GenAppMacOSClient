...
struct KLDodgerTemplate {
    ...
    static func template1(textColorPrimary: Color, buttonColorPrimary: Color, buttonTextColorPrimary: Color, buttonColorSecondary: Color) -> TemplateData {
        ...
        let text1692352260460 = TextShapeModel(shape: .text, color: textColorPrimary, x: 160, y: 130, width: 100, height: 100, text: "Frodger", size: 18, font: .bold)
        ...
        let image1692352003947 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/kldodger/bg.jpg", x: 69, y: 0, width: 250, height: 500)
        let image1692352023778 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/kldodger/bg.jpg", x: 387, y: 0, width: 250, height: 500)
        let image1692352043893 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/kldodger/bg.jpg", x: 705, y: 0, width: 250, height: 500)
        let image1692352076325 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/kldodger/acorn.png", x: 540, y: 280, width: 40, height: 45)
        let image1692352150031 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/kldodger/acorn.png", x: 448, y: 119, width: 40, height: 45)
        let image1692352178803 = ImageShapeModel(color: .clear, template: false, shape: .image, location: "\(Constant.homeDir)GeneratorProjects/resources/bannerResources/kldodger/player.png", x: 439, y: 378, width: 60, height: 50)
