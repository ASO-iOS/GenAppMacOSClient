...
struct KLSpeedTestTemplate {
    static func template1(backColorPrimary: Color, backColorSecondary: Color, surfaceColor: Color, textColorPrimary: Color, textColorSecondary: Color, appName: String) -> TemplateData {
        ...
        let text1691068875290 = TextShapeModel(shape: .text, color: textColorPrimary, x: 130, y: 45, width: 133, height: 100, text: appName, size: 28, font: .light)
        ...
        let text1691070287863 = TextShapeModel(shape: .text, color: textColorPrimary, x: 450, y: 45, width: 133, height: 100, text: appName, size: 28, font: .light)
        let text1691070328695 = TextShapeModel(shape: .text, color: textColorPrimary, x: 760, y: 45, width: 133, height: 100, text: appName, size: 28, font: .light)
