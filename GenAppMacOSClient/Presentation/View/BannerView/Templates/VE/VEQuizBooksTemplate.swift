...
struct VEQuizBooksTemplate {
    static func template1(backColorPrimary: Color, textColorPrimary: Color, textColorSecondary: Color, buttonColorPrimary: Color, appName: String) -> TemplateData {
        ...
        let text1690880880290 = TextShapeModel(shape: .text, color: textColorPrimary, x: 117, y: 248, width: 200, height: 100, text: appName, size: 32, font: .regular)
//
